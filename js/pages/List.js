...
export default {
        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>Must be on listed level (check ID before submitting)</p>
                    <p>Must include audio or clicks/taps</p>
                    <p>Must show full attempt unless first attempt</p>
                    <p>Must show endwall hit</p>
                    <p>No secret or bug routes</p>
                    <p>No easy mode records</p>
                    <p>Legacy levels accept records for 24 hours after removal</p>
    ...
    methods: {
        ...
        // ✅ REAL RANK SYSTEM (future-proof)
        getAdjustedRank(index) {
            const ignoredLevels = new Set([
                // add names here if needed later
            ]);
            ...
            for (let i = 0; i <= index; i++) {
                ...
                if (!ignoredLevels.has(level?.name)) {
                    rank++;
                }
            }
